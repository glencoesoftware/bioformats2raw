...
public enum SupportedVersions {
  ...
  NGFF_DEV("0.9.dev1", 3, new Integer[] {2, 3, 4, 5});
  ...
  /**
   * @return true if anatomical orientation (RFC-4)
   *              is supported by this version
   */
  public boolean supportsAnatomicalOrientation() {
    return supportedRFCs != null && supportedRFCs.contains(4);
  }
